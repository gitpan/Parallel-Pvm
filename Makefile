# This Makefile is for the Parallel::Pvm extension to perl.
#
...
AR_STATIC_ARGS = cr
NAME = Parallel::Pvm
DISTNAME = Parallel-Pvm
NAME_SYM = Parallel_Pvm
VERSION = 1.0
VERSION_SYM = 1_0
XS_VERSION = 1.0
INST_BIN = ./blib/bin
...
PERL = /home1/edward/bin/perl5.003
FULLPERL = /home1/edward/bin/perl5.003
...
# Parallel::Pvm might depend on some other libraries:
...
manifypods : Pvm.pm
	@$(POD2MAN) \
	Pvm.pm \
	$(INST_MAN3DIR)/Parallel::Pvm.$(MAN3EXT)
...
clean ::
	-rm -rf Pvm.c ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all perlmain.c mon.out core so_locations pm_to_blib *~ */*~ */*/*~ *$(OBJ_EXT) *$(LIB_EXT) perl.exe $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def $(BASEEXT).exp
